    ...
    <div class="block xl:grid grid-cols-2 gap-4">
        ...
        <div class="h-screen xl:h-auto flex py-5 xl:py-0 my-10 xl:my-0">
                ...
                <div class="intro-x mt-8">
                    <input type="text" class="intro-x login__input form-control py-3 px-4 block" id="id" name="id" placeholder="Id">
                    <input type="password" class="intro-x login__input form-control py-3 px-4 block mt-4" id="password" name="password" placeholder="Password">
                </div>
