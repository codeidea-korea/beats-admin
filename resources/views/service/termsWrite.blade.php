...
@section('content')
                    ...
                    <div class="overflow-x-auto">
                        <form id="termsWriteForm" method="post" action="/service/terms/add" enctype="multipart/form-data">
                                ...
                                <tr>
                                    ...
                                    <td colspan="3">
                                        <div class="relative inline-block w-56">
                                            ...
                                            <input name="apply_date" type="text" class="datepicker form-control pl-12" data-single-mode="true">
                                        </div>
                            ...
                            <div class="flex items-center justify-center mt-5">
                                <button class="btn btn-primary w-32 ml-2 mr-2 termsAddbtn">등록</button>
    ...
    <script>
        ...
        $(document).on('click','.termsAddbtn', function(){
            ...
            if($("select[name='apply_date']").val() == ""){
                alert("적용 날짜를 선택해주세요.");
            }

            $("#content").val(editor.getData());

            $('#termsWriteForm').submit();
