    ...
    <div class="main-content">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <form method="post" id="boardwriteform" role="form" class="form-horizontal" action="/admin/board/add">
                    {{ csrf_field() }}
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="field-1">제목</label>

                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="wr_title" name="wr_title" value="">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control" id="wr_content" name="wr_content" style="width:100%;height:400px;resize:none;"></textarea>
                        </div>
                    </div>
                ...
                <div style="float:right;">
                    <button class="btn btn-purple" type="button" onclick="$('#boardwriteform').submit();">등록</button>
