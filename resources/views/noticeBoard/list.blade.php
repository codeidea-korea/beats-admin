...
<div class="page-container"><!-- add class "sidebar-collapsed" to close sidebar by default, "chat-visible" to make chat appear always -->
    ...
    <div class="main-content">
        ...
        <div class="panel panel-default">
            ...
            <button class="btn btn-black" type="button" style="float:right;" onclick="location.href='/admin/board/write'">등록</button>
            <div class="panel-body">
                ...
                <table id="example-1" class="table table-striped table-bordered table-hover" >
                    ...
                    <tr>
                        ...
                        <td style="width:10%" onclick="location.href='/admin/board/view/{{$rs->idx}}'">{{$rs->wr_title}}</td>
                        <td style="width:20%">@if($rs->wr_open=='open') 노출 @else 비 노출 @endif</td>
