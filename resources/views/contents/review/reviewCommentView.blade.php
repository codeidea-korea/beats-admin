                        ...
                        <div class="preview">
                            <ul class="nav nav-boxed-tabs" role="tablist">
                                ...
                                <li class="nav-item flex-1" role="presentation">
                                    <button class="nav-link w-full py-2" type="button" role="tab" onClick="javascript:location.href = '/contents/reviewView/{{$idx}}';">기본 정보</button>
                                </li>
                                <li class="nav-item flex-1" role="presentation">
                                    <button class="nav-link w-full py-2 active" type="button" role="tab" onClick="javascript:location.href = '/contents/reviewCommentView/{{$idx}}';">댓글 내역</button>
                                </li>
                            </ul>
                        </div>
                    </div>
                            ...
                            <div class="overflow-x-auto">
                                <table class="table table-bordered table-hover table-auto">
                                    ...
                                    <tr>
                                        ...
                                        <th class="whitespace-nowrap text-center">댓글 고정</th>
                                    ...
                                    <tbody>
                                    @php $i=0; @endphp
                                    @foreach($reviewCommentData as $rs)
                                        <tr class="@if($rs->cm_main != 1 ) bg-primary/10 @endif">
                                            ...
                                            <td class="whitespace-nowrap text-center">@if($rs->product_idx != 0) 고정 @else - @endif</td>
                ...
                <div class="modal-body p-10 text-center">
                    <div class="overflow-x-auto">
                        ...
                        <tr>
                            ...
                            <td colspan="3" class="whitespace-nowrap" id="u_id">
                            </td>
                        </tr>
                        <tr>
                            <th colspan="1" class="bg-primary/10 whitespace-nowrap w-32 text-center">제품 지정</th>
                            <td colspan="3" class="whitespace-nowrap">
                                <select name="cm_open" class="form-select w-60" aria-label=".form-select-lg example" id="product_idx">
                                    <option value="0">선택한 제품이 없습니다.</option>
                                    @foreach($productsData as $rs)
                                        <option value="{{$rs->idx}}">{{$rs->name}}</option>
                                    @endforeach
                                </select>
                            </td>
                        </tr>
            ...
            jQuery.ajax({
                ...
                success: function (data) {
                    if(data.resultCode=="SUCCESS"){
                        $('#u_id')[0].innerHTML = data['response'][0].u_id;
                        ...
                        $('#product_idx').val(data['response'][0].product_idx);
